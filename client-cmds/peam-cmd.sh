...
default_peam_docker_image="ghcr.io/malik672/peam:devnet5"
...
node_docker="ghcr.io/malik672/peam:devnet5 \
      --run \
...
if [ -n "${PEAM_DOCKER_IMAGE:-}" ]; then
    node_docker="${peam_docker_image}${node_docker#"ghcr.io/malik672/peam:devnet5"}"
fi
